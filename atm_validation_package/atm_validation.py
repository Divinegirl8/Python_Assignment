import atm_validation_function
...
if 13 <= len(user) <= 16:
    ...
    if get_index == 3 and get_index_two == 7 and  total % 10 == 0:
    ...
    ********************************************    
    ...
    print(atm_validation_function.check_validity(user))
