...
print(f"""
Amount on deposit after 10 years is ${amount_after_ten_years:.1f}
Amount on deposit after 20 years is ${amount_after_twenty_years:.1f}
Amount on deposit after 30 years is ${amount_after_thirty_years:.1f}
""")
